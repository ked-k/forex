...
Route::group(['namespace' => 'forex','middleware' => ['auth','role:superadministrator|administrator|user'], 'prefix' => 'forex' ], function() {
    ...
    Route::get('/accounts/balances', [App\Http\Controllers\AccountController::class, 'index2'])->middleware(['auth','role:superadministrator']);;
    ...
    Route::post('/customers/balance/add', [App\Http\Controllers\CustomersController::class, 'storeBalance'])->name('customer-add_balance');
