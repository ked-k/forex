                            ...
                            <div class="row mb-2 mt-3">
                                ...
                                <div class="col-sm-4">
                                    <div class="text-sm">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text text-info">UGX</span>
                                                    ...
                                                    success: function(response) {
                                                        ...
                                                        if (len > 0) {
                                                            ...
                                                            for (var i = 0; i < len; i++) {
                                                                ...
                                                                document.getElementById('avamount').value = balance.toFixed(2);
                                                                document.getElementById('total_amount').value = 0;
                            ...
                            <div class="row mb-2 mt-3">
                                ...
                                <div class="col-sm-3">
                                    <div class="text-sm">
                                        ...
                                        <input type="text" class="form-control" id="initial_amount" onchange="fill()"
