...
use App\Http\Livewire\UserManagement\ManageUsersComponent;

Route::group(['prefix' => 'user-mgt', 'middleware' => ['permission:access_user_management_module']], function () {
    // Route::get('users', ManageUsersComponent::class)->name('usermanagement')->middleware('permission:view_user');
