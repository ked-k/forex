				...
				<hr/>
                                       ...
                                       @csrf
                                        ...
                                        <div class="row mb-2 mt-3">
                                            <div class="col-sm-4">
                                                ...
                                                <select class="single-select form-select" name="to_id" id="to_id" required onchange="fill()">
                                             ...
                                             <div class="col-sm-2">
                                                <div class="text-sm">
                                                    <label>Charges</label>
                                                    <input type="text" class="form-control" onchange="fill()" value="0" min="0" required name="trans_charges" id="trans_charges">
                                                </div>
                                            </div><!-- end col-->

                                             <div class="col-sm-12">
                                                 <div class="text-sm-end pt-2">
                                                     <button type="submit" class="btn btn-primary mb-2 me-1 d-block">Save Tranfer</button>
                                                 </div>
                                             </div><!-- end col-->
                                          </div>
                                          <script>
                    ...
                    <script>
                        ...
                        function fill() {
                            ...
                            var ds = document.getElementById("avamount").value-0;
                             var tcharges = document.getElementById("trans_charges").value-0
                             var trate = document.getElementById("exrate2").value-0
                             var tt = tamt1 - tcharges;
                             var mytotal = tt / trate;
                             document.getElementById("total_amount").value = tt.toFixed(2);
                             document.getElementById("ex_amount").value = mytotal.toFixed(2);
