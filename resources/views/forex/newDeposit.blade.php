...
@section('content')
			<div class="page-content">
				...
				<div class="page-breadcrumb d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">New Deposit</div>
					<div class="ps-3">
				...
				<!--end breadcrumb-->
				<h6 class="mb-0 text-uppercase">Add New Deposit</h6>
				<hr/>
                    <div class="row">
                        <div>
                            <div class="card">
                                <div class="card-header pt-0">
                                    <form method="POST" action="{{ url('forex/capital/deposit/add') }}" name="myForm"  class="needs-validation"  onsubmit="return validateForm()">
                                       @csrf
                    ...
                    <script>
                        ...
                        var totallocal = totallocal1;
                        var localAmt = totallocal1 * myrate;

                        document.getElementById("initial_amount").value = localAmt.toFixed(2);
