                                        ...
                                        <table id="example2" class="table table-striped table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                     {{-- @php($x=$value->available_balance/$value->buying_rate??1)
                                                      @money($x) --}}
                                                      @money($value->available_balance)
                                                    </td>
                                                    <td class="text-end">
                                                        @php($available_balance = $value->available_balance*$value->buying_rate)
                                                        @money($available_balance) <input type="hidden" value="{{$available_balance}}" name="amount"></td>
