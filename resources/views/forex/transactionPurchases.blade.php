                                                           ...
                                                           <div class="modal fade" id="AccountModal{{$value->reff_number}}" tabindex="-1" aria-hidden="true">
                                                            <div class="modal-dialog modal-md">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ url('forex/transactions/delete/purchase') }}" method="POST">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <div class="mb-3">
                                                                                            ...
                                                                                            <input type="hidden"  name="supplier_id" value="{{ $value->supplier_id}}" class="form-control"  required readonly>
                                                                                        </div>
